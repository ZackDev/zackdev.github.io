...
return b?d.attr({"class":"highcharts-"+b}):d};z.prototype.image=function(b,d,g,a,k,c){var z={preserveAspectRatio:"none"},l=function(b,d){b.setAttributeNS?b.setAttributeNS("http://www.w3.org/1999/xlink","href",d):b.setAttribute("hc-svg-href",d)};1<arguments.length&&r(z,{x:d,y:g,width:a,height:k});var I=this.createElement("image").attr(z);z=function(d){l(I.element,b);c.call(I,d)};if(c){l(I.element,"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==");var e=new K.Image;A(e,"load",
